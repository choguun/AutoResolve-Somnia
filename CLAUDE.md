...
- **Current deployed contract (v4)**:
  `0xE364Ab693000E0384dD8f69Cf0F4Fbce54248DFC` on Somnia Shannon Testnet
...
- **Historical E2E proof**: market #1 on the v2 contract resolved `YES` via parse
  ...
  (`claimTx: 0x888327…2380`). The v4 deployment is the current live target.
