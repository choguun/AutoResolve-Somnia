...
export function getAutoResolveAgentManifest() {
  return {
    ...
    // 9 reads). Same pattern as useMyBetsMarkets (L162) and
    // useUserBets (L212). Promise.all preserves input order, so
